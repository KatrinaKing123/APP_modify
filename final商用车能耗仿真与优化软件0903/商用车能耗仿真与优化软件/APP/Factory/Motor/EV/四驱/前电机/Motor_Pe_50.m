...
Motor_PE_50.mc_max_spd_br = [1000 
1500 
2000 
2500 
3000 
...
Motor_PE_50.mc_max_gen_trq=-1*[185 
185 
185 
185 
185 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mc_mass = 58;
Motor_PE_50.name = 'Motor_Pe_50';

% 峰值功率
Motor_PE_50.mc_max_P = 90; % kw

% 额定功率
Motor_PE_50.mc_PE = 50; % KW

% 峰值扭矩
Motor_PE_50.mc_max_trq_dr_value = 185; % Nm
...
%% 用于DP计算的
Motor_PE_50.Speed = Motor_PE_50.mc_map_spd*(2*pi/60);
Motor_PE_50.W_Row = Motor_PE_50.Speed;

Motor_PE_50.T_Col = Motor_PE_50.mc_map_trq;
Motor_PE_50.Trq_Max = Motor_PE_50.mc_max_trq_dr; 
Motor_PE_50.Trq_Min = Motor_PE_50.Trq_Max * -1;

Motor_PE_50.Eff_map = Motor_PE_50.mc_eff_map';

if Choose_model == 1
    Motor{end+1} = Motor_PE_50;
elseif Siqu==0 & Liangqu ==1
    Motor{1,1} = Motor_PE_50;
elseif Siqu==1 & Liangqu ==0
    Motor_front{1,1} = Motor_PE_50;

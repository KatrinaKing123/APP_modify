...
T100=[310 310	310	310	310	310	310	310	310	276	243	214	186	162	139	121	107	98	90	85	76	73	69	66	64];
% i0=12.336;
% r0=0.346;
V100=n100*0.377*r0/i0;
Motor_PE_FCS_1.mc_map_spd = [0 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000 11500];       % Unit: rpm

Motor_PE_FCS_1.mc_map_trq = [-215 -200 -180 -160 -140 -120 -100 -80 -60 -40 -20 ...
                    0 20 40 60 80 100 120 140 160 180 200 215];                               % Unit: Nm

% Motor_PE_FCS_1.mc_max_spd_dr = Motor_PE_FCS_1.mc_map_spd;
% Motor_PE_FCS_1.mc_max_trq_dr = [200 200 200 175.2 131.4 105.1 87.6 75.1 65.7 58.4 52.4 50.5]*1.075;

Motor_PE_FCS_1.mc_max_spd_dr =n100;
Motor_PE_FCS_1.mc_max_trq_dr =T100;
Motor_PE_FCS_1.mc_P_dr=[0
16 
32 
49 
65 
...
Motor_PE_FCS_1.mc_max_spd_br = Motor_PE_FCS_1.mc_max_spd_dr;
Motor_PE_FCS_1.mc_max_gen_trq = -1 * Motor_PE_FCS_1.mc_max_trq_dr;                                % Unit: Nm

                           
Motor_PE_FCS_1.mc_eff_map = [...
...
Motor_PE_FCS_1.name = 'Motor_PE_FCS_1';

% 峰值功率
% Motor_PE_FCS_1.mc_max_P = 130; % kw 
Motor_PE_FCS_1.mc_max_P = interp1(Motor_PE_FCS_1.mc_max_spd_dr, Motor_PE_FCS_1.mc_P_dr, Vi*i0/r0/0.377) ;
% 额定功率
Motor_PE_FCS_1.mc_PE = 65; % KW                                            

% 峰值扭矩
Motor_PE_FCS_1.mc_max_trq_dr_value = 310; % Nm

Motor{end+1} = Motor_PE_FCS_1;

Motor_name.('Motor_PE_FCS_1')='Motor_PE_FCS_1';
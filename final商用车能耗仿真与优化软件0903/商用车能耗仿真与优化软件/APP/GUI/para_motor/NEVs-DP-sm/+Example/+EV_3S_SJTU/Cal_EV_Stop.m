function OutPut_K = Cal_EV_Stop(PHEV,Input_K) 
...
%     OutPut_K.W_m_K_Grid = zeros(Row_Num, Col_Num);
    OutPut_K.T_m_Front_K_Grid = zeros(Row_Num, Col_Num);
    OutPut_K.W_m_Front_K_Grid = zeros(Row_Num, Col_Num);
    OutPut_K.T_m_Rear_K_Grid = zeros(Row_Num, Col_Num);
    OutPut_K.W_m_Rear_K_Grid = zeros(Row_Num, Col_Num);
%     OutPut_K.T_Brake_Front_K_Grid = zeros(Row_Num, Col_Num);
%     OutPut_K.T_Brake_Rear_K_Grid = zeros(Row_Num, Col_Num);
    
    
    OutPut_K.SOC_K_Grid = SOC_K(Index_J_K);
    OutPut_K.SOC_K_1_Grid = SOC_K_1_Grid(Index_J_K);
    OutPut_K.G_K_Grid =  G_K_1_Grid(Index_J_K);
    OutPut_K.G_K_1_Grid =   G_K_1_Grid(Index_J_K);
    ...
    OutPut_K.M_K_Grid =  M_K_1_Grid(Index_J_K);

...
%     EV = Example.EV_3S_SJTU.Cal_EV_Model(velocity, Index_Start, Index_End, matchIndex, Match_selected);
    ...
    %% Initial state
    Input_K = NEVs_DP_DM.NEVs_DP_DM.Example.EV_3S_SJTU.Init_Put_K_Struct();
    ...
    for Step = 1: EV.Cycle_Num - 1
        ...
        %% Main 
        Out_Put_K= NEVs_DP_DM.NEVs_DP_DM.Example.EV_3S_SJTU.DP_Main_Function(EV,SOC_K_1,Input_K,Step);
        
        %% Data merge
        OutPut_K = NEVs_DP_DM.NEVs_DP_DM.Example.EV_3S_SJTU.CS_Data_Merge(Out_Put_K);

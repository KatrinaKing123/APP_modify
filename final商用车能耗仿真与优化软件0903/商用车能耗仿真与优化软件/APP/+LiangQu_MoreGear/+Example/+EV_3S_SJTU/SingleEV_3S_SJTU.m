...
EV = LiangQu_MoreGear.Example.EV_3S_SJTU.Cal_EV_Model(Index_Start, Index_End, velocity,Gear, Motor, Batt);
...
%% Initial state
Input_K = LiangQu_MoreGear.Example.EV_3S_SJTU.Init_Put_K_Struct();
...
for Step = 1: EV.Cycle_Num - 1
    ...
    %% Main 
    Out_Put_K= LiangQu_MoreGear.Example.EV_3S_SJTU.DP_Main_Function(EV,SOC_K_1,Input_K,Cost,Step);
    
    %% Data merge
    OutPut_K = LiangQu_MoreGear.Example.EV_3S_SJTU.CS_Data_Merge(Out_Put_K);

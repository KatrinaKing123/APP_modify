...
%    switch1    - if Chrom == [] and
%                switch1 == 1 (or []) return boundaries
%                switch1 == 2 return title
%                switch1 == 3 return value of global minimum
%
% Output parameters:
%    ObjVal    - Column vector containing the objective values of the
%                individuals in the current population.
%                if called with Chrom == [], then ObjVal contains
%                switch1 == 1, matrix with the boundaries of the function
%                switch1 == 2, text for the title of the graphic output
%                switch1 == 3, value of global minimum
%                

% Author:     Hartmut Pohlheim
% History:    26.11.93     file created
%             27.11.93     text of title and switch1 added
%             30.11.93     show Dim in figure title
%             16.12.93     switch1 == 3, return value of global minimum
